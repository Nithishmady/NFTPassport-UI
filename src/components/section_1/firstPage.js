           ...
           <Box component="div" className={classes.root}>
                ...
                <Box component="div" className={classes.Box3}>
                     ...
                     <Box component="div" style={{display:"flex",flex:1,justifyContent:"flex-start",alignItems:"center",}}>
                        <Box component="div" className={classes.subComponent1}>
                             <Box component="div">
                                  <Box component="div">
                                     <p style={{fontSize:"10px",color:"#4F5360",position:"relative",top:"-8px",left:"20px",fontWeight:"500",borderRadius:" 3.53879px"}}>I am fine, How are you?</p>
                                  </Box>
                             </Box>
                        </Box>
                    </Box>
                ...
                <Box component="div" style={{display:"flex",flex:1,flexDirection:"row"}}>
                   ...
                   <Box component="div" style={{display:"flex",flex:0.4, paddingTop:"20px", height:"35px",  borderRadius:"16.3px",boxShadow:" 0px 5.16667px 10.3333px rgba(0, 0, 0, 0.05)"}}>
                              <Box component="image">
                                  <Image src={VideoIcon} width="15px" height="15px" style={{position:"relative",bottom:"15px",left:"13px"}}></Image>
                             </Box>
                          
                             <Box component="div">
                                  <Box component="div">
                                     <p style={{fontSize:"10px",color:"#27333F",position:"relative",bottom:"8px",left:"20px"}}>Video Calls</p>
                                  </Box>
                             </Box> 
                   </Box>
                </Box>
                ...
                <Box component="div" className={classes.Box5}>
                    ...
                    <Box component="div" style={{display:"flex",flex:0.7, paddingTop:"20px", height:"35px",  borderRadius:" 3.53879px;",boxShadow:" 0px 5.16667px 10.3333px rgba(0, 0, 0, 0.05)"}}>
                            <Box component="div">
                                  <Box component="div">
                   ...
                   <Box component="div" style={{display:"flex",flex:0.7, paddingTop:"20px", height:"35px",  borderRadius:" 3.53879px",boxShadow:" 0px 5.16667px 10.3333px rgba(0, 0, 0, 0.05)",marginTop:"15px"}}>
                            <Box component="div">
                                  <Box component="div">
